...
@Validated
@Api(tags = "单个编程题标签管理")
@RequestMapping(value = "/programTag", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class ProgramTagController {
    ...
    public ResponseEntity removeById(@PathVariable int programTagId) {
    ...
    public ResponseEntity updateTag(@PathVariable int programTagId,
